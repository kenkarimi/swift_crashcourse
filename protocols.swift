...
class BMW: Car, CarPrototype { //Since CarPrototype is specified here(sort of as would happen in Java) we're required to implement all it's variables & methods or the compiler will complain.
    var color: String
